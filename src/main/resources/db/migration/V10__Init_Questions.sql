/* АЛМ/ТА **/
 ...
 insert
    ...
    values
        ('Мили', TRUE, (select id from question where question like 'Какие виды автоматов Вы знаете?' ));
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
	('Мура', TRUE, (select id from question where question like 'Какие виды автоматов Вы знаете?' ));
    insert
    into
        "answer_choice"
        ("answer", "is_right", "question_id")
    values
	('Мули', FALSE, (select id from question where question like 'Какие виды автоматов Вы знаете?' ));
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
	('Мира', FALSE, (select id from question where question like 'Какие виды автоматов Вы знаете?' ));
...
into
    ...
    ("answer", "is_right", "question_id")
values
    ('Условные', TRUE, (select id from question where question like 'Какие виды переходов Вы знаете?' ));
...
into
    ...
    ("answer", "is_right", "question_id")
values
('Безусловные', TRUE, (select id from question where question like 'Какие виды переходов Вы знаете?' ));
insert
into
    "answer_choice"
    ("answer", "is_right", "question_id")
values
('Простые', FALSE, (select id from question where question like 'Какие виды переходов Вы знаете?' ));
...
into
    ...
    ("answer", "is_right", "question_id")
values
('Сложные', FALSE, (select id from question where question like 'Какие виды переходов Вы знаете?' ));
 ...
 insert
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Мили', TRUE, (select id from question where question like 'У какого автомата состояния проставляются после операторных вершин?' ));
 ...
 insert
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Мура', TRUE, (select id from question where question like 'Автомат, состояния которого проставляются в операторных вершинах' ));
...
/*5 question*/
 insert
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Дуги', TRUE, (select id from question where question like 'Основные элементы граф-схемы автомата' ));
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Вершины', TRUE, (select id from question where question like 'Основные элементы граф-схемы автомата' ));
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Ромбики', TRUE, (select id from question where question like 'Основные элементы граф-схемы автомата' ));
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Квадратики', TRUE, (select id from question where question like 'Основные элементы граф-схемы автомата' ));
 ...
 insert
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Логическая', TRUE, (select id from question where question like 'Как называется функция, переменные которой могу принимать значения либо 0, либо 1?' ));
...
/*7 question*/
 insert
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Отриацание', TRUE, (select id from question where question like 'Логическая функция, которая преобразует 0 в 1 и наоборот?' ));
...
/*8 question*/
 insert
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('И', TRUE, (select id from question where question like 'Логическая функция, которая дает единицу, когда только оба операнда 1' ));
 /*9 question*/
 insert
    into
        "question"
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Или', TRUE, (select id from question where question like 'Логическая функция, которая дает 0, когда только оба операнда 0' ));
 ...
 insert
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Исключающее или', TRUE, (select id from question where question like 'Логическая функция, которая дает 0, когда оба операнда одинаковые' ));
 ...
 insert
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Карно', TRUE, (select id from question where question like 'Один из методов минимизации лог.функций: карты ...?' ));
 ...
 insert
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Истинности', TRUE, (select id from question where question like 'Таблица, где представлены всевозможные наборы операндов и всевозможные соотвествуюшие значения лог. функции ...?' ));
...
/*13 question*/
 insert
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('Квайна', TRUE, (select id from question where question like 'Метод минимизации, использующий операции попарного неполного склеивания и элементарного поглощения (Фамилия)' ));
...
/*14 question*/
 insert
    ...
    into
        ...
        ("answer", "is_right", "question_id")
    values
        ('1', TRUE, (select id from question where question like 'Результат логической функции х1 И х2 = 1, чему равны операнды? (Число)' ));
