...
values ('Мили', TRUE, (select id from questions where question like 'Какие виды автоматов Вы знаете?'));

insert
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('Мура', TRUE, (select id from questions where question like 'Какие виды автоматов Вы знаете?'));
insert
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('Мули', FALSE, (select id from questions where question like 'Какие виды автоматов Вы знаете?'));

insert
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('Мира', FALSE, (select id from questions where question like 'Какие виды автоматов Вы знаете?'));
...
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('Условные', TRUE, (select id from questions where question like 'Какие виды переходов Вы знаете?'));

insert
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('Безусловные', TRUE, (select id from questions where question like 'Какие виды переходов Вы знаете?'));
insert
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('Простые', FALSE, (select id from questions where question like 'Какие виды переходов Вы знаете?'));

insert
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('Сложные', FALSE, (select id from questions where question like 'Какие виды переходов Вы знаете?'));
...
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('Дуги', TRUE, (select id from questions where question like 'Основные элементы граф-схемы автомата'));

insert
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('Вершины', TRUE, (select id from questions where question like 'Основные элементы граф-схемы автомата'));

insert
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('Ромбики', TRUE, (select id from questions where question like 'Основные элементы граф-схемы автомата'));

insert
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('Квадратики', TRUE, (select id from questions where question like 'Основные элементы граф-схемы автомата'));
...
values ('Отриацание', TRUE,
        (select id from questions where question like 'Логическая функция, которая преобразует 0 в 1 и наоборот?'));
...
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('Карно', TRUE,
        (select id from questions where question like 'Один из методов минимизации лог.функций: карты ...?'));
...
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('И', TRUE, (select id from questions where question like 'Конъюнкция это логическое ...?'));
/*****************/
/*16 question*/
insert
into "questions"
...
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('AX', TRUE,
        (select id from questions where question like '16 битный аккумуляторный регистр (большими буквами)'));
...
into "answer_choices"
    ("answer", "is_right", "question_id")
values ('CPU', TRUE, (select id from questions where question like 'Английская аббревиатура центрального процессора'));
...
insert
into answer_options (answer, is_right, selectable_question_id)
values ('Мили', true,
        (select id from questionsN where questionsN.question like 'Выберите конечные детерминирование автоматы'));
insert
into answer_options (answer, is_right, selectable_question_id)
values ('Мура', false,
        (select id from questionsN where questionsN.question like 'Выберите конечные детерминирование автоматы'));
...
/*23 question*/
insert into questionsN (question_discriminator, complexity, question, question_type, subject_id, theme_id)
values ('match', 3, 'Сопоставьте элементы блок-схемы', 2, (select id from subjects where name like 'АЛМ'),
        (select id from themes where name like 'Конечные автоматы'));
insert
into answer_options (answer)
values ('овал');
insert
into answer_options (answer)
values ('начало');
insert into matchable_answer_options (key_id, matchable_question_id, value_id)
values ((select id from answer_options where answer like 'овал'),
        (select id from questionsN where question like 'Сопоставьте элементы блок-схемы'),
        (select id from answer_options where answer like 'начало'));
...
values ('условие');
insert into matchable_answer_options (key_id, matchable_question_id, value_id)
values ((select id from answer_options where answer like 'ромб'),
        (select id from questionsN where question like 'Сопоставьте элементы блок-схемы'),
        (select id from answer_options where answer like 'условие'));
...
values ('состояние');
insert into matchable_answer_options (key_id, matchable_question_id, value_id)
values ((select id from answer_options where answer like 'вершина'),
        (select id from questionsN where question like 'Сопоставьте элементы граф-схемы автомата'),
        (select id from answer_options where answer like 'состояние'));
...
values ('дуга');
insert into matchable_answer_options (key_id, matchable_question_id, value_id)
values ((select id from answer_options where answer like 'переход'),
        (select id from questionsN where question like 'Сопоставьте элементы граф-схемы автомата'),
        (select id from answer_options where answer like 'дуга'));
...
into answer_options (answer, is_right, selectable_question_id)
values ('начало', true,
        (select id from questionsN where questionsN.question like 'Последовательность программы'));
insert
into answer_options (answer, is_right, selectable_question_id)
