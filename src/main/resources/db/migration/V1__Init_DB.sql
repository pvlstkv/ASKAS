...
create table "fmconfig_per_criteria"
(
    "id"                bigserial not null,
    "binary_border"     int4,
    "four_five_border"  int4,
    "is_binary_mark"    boolean,
    "passed_value"      int4,
    "three_four_border" int4,
    "two_three_border"  int4,
    primary key ("id")
);
create table "flex_mark"
(
    "id"                  bigserial not null,
    "study_group_id"      int8,
...
alter table "flex_mark"
    add constraint "FK34xxhmwp1utiuv5uevl93fnrh" foreign key ("study_group_id") references "study_groups";
alter table "flex_mark"
    add constraint "FKjcgostxngx26rcg09j6ia33fq" foreign key ("subject_semester_id") references "subject_semesters";
alter table "flex_mark"
...
alter table "flex_mark"
    add constraint "FK5ld1c20swixfpto6iygraiq5k" foreign key ("visit_id") references "fmconfig_per_criteria";
