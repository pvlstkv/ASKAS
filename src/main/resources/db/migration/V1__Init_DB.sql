create table "answer_choice" ("id"  serial not null, "answer" varchar(255), "is_right" boolean, "question_id" int8, primary key ("id"));
 ...
 create table "fmconfig_per_criteria" ("id"  bigserial not null, "binary_border" int4, "four_five_border" int4, "is_binary_mark" boolean, "passed_value" int4, "three_four_border" int4, "two_three_border" int4, primary key ("id"));
 create table "flex_mark" ("id"  bigserial not null, "study_group_id" int8, "subject_semester_id" int8, "task_mark_id" int8, "task_on_time_id" int8, "teacher_id" int4, "test_mark_id" int8, "visit_id" int8, primary key ("id"));
 ...
 alter table "flex_mark" add constraint "FK34xxhmwp1utiuv5uevl93fnrh" foreign key ("study_group_id") references "study_groups";
 alter table "flex_mark" add constraint "FKjcgostxngx26rcg09j6ia33fq" foreign key ("subject_semester_id") references "subject_semesters";
 alter table "flex_mark" add constraint "FKgc2ebvuh5hvkmma13fw7xh7kq" foreign key ("task_mark_id") references "fmconfig_per_criteria";
 alter table "flex_mark" add constraint "FKfeu8x6jsrqsx2v595jh1efvxo" foreign key ("task_on_time_id") references "fmconfig_per_criteria";
 alter table "flex_mark" add constraint "FKt689tp18e2n1a9xq2ypaqwprs" foreign key ("teacher_id") references "users";
 alter table "flex_mark" add constraint "FKgayp5rhvwh24pxk84cc7ev6lu" foreign key ("test_mark_id") references "fmconfig_per_criteria";
 alter table "flex_mark" add constraint "FK5ld1c20swixfpto6iygraiq5k" foreign key ("visit_id") references "fmconfig_per_criteria";
