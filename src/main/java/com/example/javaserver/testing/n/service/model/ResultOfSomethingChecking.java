...
public class ResultOfSomethingChecking {
    ...
    public <T, K> ResultOfSomethingChecking checkIfExistsInDB(T something, K repo, ResultOfSomethingChecking prevResult) {
        ...
        if (something instanceof QuestionData && repo instanceof QuestionRepo) {
            return checkQuestion((QuestionData) something, (QuestionRepo) repo, newResult);
        }
    ...
    private static ResultOfSomethingChecking checkQuestion(QuestionData question, QuestionRepo repo, ResultOfSomethingChecking result) {
