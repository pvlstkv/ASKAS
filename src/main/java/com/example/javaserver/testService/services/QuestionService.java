...
//    public ResponseEntity<?> createQuestions(RequestedTest requestedTest, String token) {
    public ResponseEntity<?> createQuestions(String token) {
//        try {
...
//                long m = newQuestion.getId();
//            }
//            //        List<Long> a = new ArrayList<>(Arrays.asList(1L, 2L, 3L, 4L));
//            //        List<Question> q = questionRepo.findAllById(a);
...
//        }
    ...
    public ResponseEntity<?> updateQuestions( String token) {
