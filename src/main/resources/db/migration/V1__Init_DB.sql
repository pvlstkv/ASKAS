create sequence "hibernate_sequence" start 1 increment 1;
    ...
    create table "file" ("id" int4 not null, "created_by" bytea, "created_date" timestamp, "last_modified_by" bytea, "last_modified_date" timestamp, "content" varchar(255), "name" varchar(255), primary key ("id"));
    ...
    create table "visits" ("id"  bigserial not null, "comment" varchar(255), "is_visited" boolean not null, "journal_id" int8, "user_id" int4, primary key ("id"));
